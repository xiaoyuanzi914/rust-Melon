...
extern "C" {
    ...
    fn mln_lang_var_set_int(var: *mut mln_lang_var_t, i: mln_s64_t);
    fn mln_lang_var_set_real(var: *mut mln_lang_var_t, r: libc::c_double);
...
#[no_mangle]
pub static mut mln_lang_int_oprs: mln_lang_method_t = unsafe {
    {
...
static mut mln_lang_int_opr_names: [mln_string_t; 36] = [mln_string_t {
...
#[inline]
unsafe extern "C" fn mln_lang_int_var_toint(mut var: *mut mln_lang_var_t) -> mln_s64_t {
    let mut i: mln_s64_t = 0 as libc::c_int as mln_s64_t;
    ...
    match (*val).type_0 {
        ...
        2 => {
            i = (if (*val).data.b as libc::c_int != 0 {
                1 as libc::c_int
            } else {
                0 as libc::c_int
            }) as mln_s64_t;
        ...
        3 => {
            i = (*val).data.f as mln_s64_t;
        }
        4 => {
            let mut s: *mut mln_string_t = (*val).data.s;
            let mut buf: mln_u8ptr_t = malloc(
                ((*s).len).wrapping_add(1 as libc::c_int as libc::c_ulong),
            ) as mln_u8ptr_t;
            if !buf.is_null() {
                memcpy(
                ...
                *buf.offset((*s).len as isize) = 0 as libc::c_int as libc::c_uchar;
                sscanf(
...
#[inline]
unsafe extern "C" fn mln_lang_int_var_toreal(
    ...
    match (*val).type_0 {
        1 => {
            r = (*val).data.i as libc::c_double;
        }
        2 => {
            r = if (*val).data.b as libc::c_int != 0 {
                1.0f64
            } else {
...
unsafe extern "C" fn mln_lang_int_pluseq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(1 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if type_0 == 5 as libc::c_int || type_0 == 6 as libc::c_int
        || type_0 == 7 as libc::c_int || type_0 == 2 as libc::c_int
    ...
    if type_0 == 3 as libc::c_int {
        mln_lang_var_set_real(
            op1,
            mln_lang_int_var_toreal(op1) + mln_lang_int_var_toreal(op2),
        );
    } else {
        mln_lang_var_set_int(
            op1,
            mln_lang_int_var_toint(op1) + mln_lang_int_var_toint(op2),
        );
    }
    (*op1).ref_0 = ((*op1).ref_0).wrapping_add(1);
    (*op1).ref_0;
...
unsafe extern "C" fn mln_lang_int_subeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(2 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_lmoveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(3 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_rmoveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(4 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_muleq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(5 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_diveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(6 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if type_0 == 3 as libc::c_int {
        let mut r: libc::c_double = mln_lang_int_var_toreal(op2);
        let mut tmp: libc::c_double = if r < 0 as libc::c_int as libc::c_double {
            -r
        } else {
            r
        };
        ...
        let mut i: mln_s64_t = mln_lang_int_var_toint(op2);
        if i == 0 {
            mln_lang_errmsg(
                ctx,
                b"Division by zero.\0" as *const u8 as *const libc::c_char
...
unsafe extern "C" fn mln_lang_int_oreq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(7 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    mln_lang_var_set_int(op1, mln_lang_int_var_toint(op1) | mln_lang_int_var_toint(op2));
    (*op1).ref_0 = ((*op1).ref_0).wrapping_add(1);
    (*op1).ref_0;
    *ret = op1;
    return 0 as libc::c_int;
}
unsafe extern "C" fn mln_lang_int_andeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(8 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_xoreq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(9 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_modeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(10 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if i == 0 {
        mln_lang_errmsg(
            ctx,
            b"Modulo by zero.\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        );
        return -(1 as libc::c_int);
    }
    mln_lang_var_set_int(op1, mln_lang_int_var_toint(op1) % i);
...
unsafe extern "C" fn mln_lang_int_cor(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(11 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    let mut i: mln_s64_t = mln_lang_int_var_toint(op1) | mln_lang_int_var_toint(op2);
    val = mln_lang_val_new(
        ctx,
        1 as libc::c_int,
...
unsafe extern "C" fn mln_lang_int_cand(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(12 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_cxor(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(13 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_equal(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(14 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    let mut val: *mut mln_lang_val_t = 0 as *mut mln_lang_val_t;
    let mut b: mln_u8_t = (mln_lang_int_var_toint(op1) == mln_lang_int_var_toint(op2))
        as libc::c_int as mln_u8_t;
    val = mln_lang_val_new(
        ctx,
        2 as libc::c_int,
...
unsafe extern "C" fn mln_lang_int_nonequal(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(15 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_less(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(16 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if type_0 == 4 as libc::c_int {
        ...
        let mut handler: mln_lang_op = (*method).less_handler;
        if handler.is_none() {
            mln_lang_errmsg(
                ctx,
                b"Operation NOT support.\0" as *const u8 as *const libc::c_char
    ...
    if type_0 == 3 as libc::c_int {
        b = (mln_lang_int_var_toreal(op1) < mln_lang_int_var_toreal(op2)) as libc::c_int
            as mln_u8_t;
    } else {
        b = (mln_lang_int_var_toint(op1) < mln_lang_int_var_toint(op2)) as libc::c_int
            as mln_u8_t;
    }
    val = mln_lang_val_new(
        ctx,
...
unsafe extern "C" fn mln_lang_int_lesseq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(17 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if type_0 == 4 as libc::c_int {
        ...
        let mut handler: mln_lang_op = (*method).lesseq_handler;
        if handler.is_none() {
            mln_lang_errmsg(
                ctx,
                b"Operation NOT support.\0" as *const u8 as *const libc::c_char
...
unsafe extern "C" fn mln_lang_int_grea(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(18 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if type_0 == 4 as libc::c_int {
        ...
        let mut handler: mln_lang_op = (*method).grea_handler;
        if handler.is_none() {
            mln_lang_errmsg(
                ctx,
                b"Operation NOT support.\0" as *const u8 as *const libc::c_char
...
unsafe extern "C" fn mln_lang_int_greale(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(19 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if type_0 == 4 as libc::c_int {
        ...
        let mut handler: mln_lang_op = (*method).greale_handler;
        if handler.is_none() {
            mln_lang_errmsg(
                ctx,
                b"Operation NOT support.\0" as *const u8 as *const libc::c_char
...
unsafe extern "C" fn mln_lang_int_lmov(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(20 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    let mut type_0: mln_s32_t = (*(*op2).val).type_0;
    if type_0 == 5 as libc::c_int || type_0 == 6 as libc::c_int
        || type_0 == 7 as libc::c_int || type_0 == 3 as libc::c_int
        || type_0 == 2 as libc::c_int || type_0 == 0 as libc::c_int
    {
        mln_lang_errmsg(
            ctx,
            b"Operation NOT support.\0" as *const u8 as *const libc::c_char
...
unsafe extern "C" fn mln_lang_int_rmov(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(21 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_plus(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(22 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    let mut val: *mut mln_lang_val_t = 0 as *mut mln_lang_val_t;
    if type_0 == 3 as libc::c_int {
        let mut r: libc::c_double = mln_lang_int_var_toreal(op1)
...
unsafe extern "C" fn mln_lang_int_sub(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(23 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_mul(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(24 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_div(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(25 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    let mut val: *mut mln_lang_val_t = 0 as *mut mln_lang_val_t;
    if type_0 == 3 as libc::c_int {
        let mut tmp: libc::c_double = mln_lang_int_var_toreal(op2);
        let mut tmpr: libc::c_double = if tmp < 0 as libc::c_int as libc::c_double {
            -tmp
        } else {
            tmp
        };
        ...
        let mut r: libc::c_double = mln_lang_int_var_toreal(op1) / tmp;
        val = mln_lang_val_new(
            ctx,
            3 as libc::c_int,
            &mut r as *mut libc::c_double as *mut libc::c_void,
        ...
        let mut tmp_0: mln_s64_t = mln_lang_int_var_toint(op2);
        if tmp_0 == 0 {
            mln_lang_errmsg(
                ctx,
                b"Division by zero.\0" as *const u8 as *const libc::c_char
        ...
        let mut i: mln_s64_t = mln_lang_int_var_toint(op1) / tmp_0;
        val = mln_lang_val_new(
            ctx,
            1 as libc::c_int,
            &mut i as *mut mln_s64_t as *mut libc::c_void,
...
unsafe extern "C" fn mln_lang_int_mod(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(26 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if type_0 == 5 as libc::c_int || type_0 == 6 as libc::c_int
        || type_0 == 7 as libc::c_int || type_0 == 2 as libc::c_int
        || type_0 == 3 as libc::c_int || type_0 == 0 as libc::c_int
    {
        mln_lang_errmsg(
            ctx,
            b"Operation NOT support.\0" as *const u8 as *const libc::c_char
    ...
    let mut val: *mut mln_lang_val_t = 0 as *mut mln_lang_val_t;
    let mut tmp: mln_s64_t = mln_lang_int_var_toint(op2);
    if tmp == 0 {
        mln_lang_errmsg(
            ctx,
            b"Modulo by zero.\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ...
    let mut i: mln_s64_t = mln_lang_int_var_toint(op1) % tmp;
    val = mln_lang_val_new(
        ctx,
        1 as libc::c_int,
        &mut i as *mut mln_s64_t as *mut libc::c_void,
...
unsafe extern "C" fn mln_lang_int_sdec(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(27 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    let mut val: *mut mln_lang_val_t = 0 as *mut mln_lang_val_t;
    let mut i: mln_s64_t = mln_lang_int_var_toint(op1);
    mln_lang_var_set_int(op1, i - 1 as libc::c_int as libc::c_long);
    val = mln_lang_val_new(
        ctx,
        1 as libc::c_int,
        &mut i as *mut mln_s64_t as *mut libc::c_void,
...
unsafe extern "C" fn mln_lang_int_sinc(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(28 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_index(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(29 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_property(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(30 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_negative(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(31 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_reverse(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(32 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_not(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(33 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    let mut val: *mut mln_lang_val_t = 0 as *mut mln_lang_val_t;
    let mut b: mln_u8_t = (mln_lang_int_var_toint(op1) == 0) as libc::c_int as mln_u8_t;
    val = mln_lang_val_new(
        ctx,
        2 as libc::c_int,
        &mut b as *mut mln_u8_t as *mut libc::c_void,
...
unsafe extern "C" fn mln_lang_int_pinc(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(34 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_int_pdec(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_int_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_int_opr_names.as_mut_ptr().offset(35 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn run_static_initializers() {
    mln_lang_int_opr_names = [
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_assign_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_pluseq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_subeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_lmoveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_rmoveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_muleq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_diveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_oreq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_andeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_xoreq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_modeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_cor_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_cand_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_cxor_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_equal_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_nonequal_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_lt_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_le_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_gt_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_ge_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_lmov_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_rmov_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_plus_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_sub_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_mul_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_div_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_mod_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_sdec_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_sinc_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_index_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_property_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 26]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_negative_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 26]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_reverse_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_not_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_pinc_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__int_pdec_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
