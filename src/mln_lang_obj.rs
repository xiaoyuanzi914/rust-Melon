...
extern "C" {
    ...
    fn mln_lang_funccall_val_object_add(
        func: *mut mln_lang_funccall_val_t,
        obj_val: *mut mln_lang_val_t,
    );
    fn mln_lang_var_create_call(
        ctx: *mut mln_lang_ctx_t,
        call: *mut mln_lang_funccall_val_t,
    ) -> *mut mln_lang_var_t;
    ...
    fn mln_lang_var_free(data: *mut libc::c_void);
    fn mln_lang_var_dup(
        ctx: *mut mln_lang_ctx_t,
        var: *mut mln_lang_var_t,
    ) -> *mut mln_lang_var_t;
    ...
    fn mln_lang_set_member_search(
        members: *mut mln_rbtree_t,
        name: *mut mln_string_t,
    ) -> *mut mln_lang_var_t;
    fn mln_lang_funccall_val_obj_operator(
        ctx: *mut mln_lang_ctx_t,
        obj: *mut mln_lang_var_t,
        name: *mut mln_string_t,
...
#[no_mangle]
pub static mut mln_lang_obj_oprs: mln_lang_method_t = unsafe {
    {
...
static mut mln_lang_obj_opr_names: [mln_string_t; 36] = [mln_string_t {
    data: 0 as *mut libc::c_uchar,
    len: 0,
    data_ref_pool_ref_0: [0; 4],
    c2rust_padding: [0; 4],
}; 36];
unsafe extern "C" fn mln_lang_obj_assign(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
) -> libc::c_int {
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(0 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_pluseq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(1 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_subeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(2 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_lmoveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(3 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_rmoveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(4 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_muleq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(5 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_diveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(6 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_oreq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(7 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_andeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(8 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_xoreq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(9 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_modeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op2,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(10 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_cor(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(11 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_cand(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(12 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_cxor(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(13 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_equal(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(14 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    if !((*(*op1).val).type_0 != (*(*op2).val).type_0) {
        if !((*(*op1).val).data.obj != (*(*op2).val).data.obj) {
...
unsafe extern "C" fn mln_lang_obj_nonequal(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(15 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_less(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(16 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_lesseq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(17 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_grea(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(18 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_greale(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(19 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_lmov(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(20 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_rmov(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(21 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_plus(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(22 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_sub(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(23 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_mul(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(24 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_div(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(25 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_mod(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(26 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_sdec(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(27 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_sinc(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(28 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_index(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(29 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_property(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(30 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
    ...
    let mut obj: *mut mln_lang_object_t = (*(*op1).val).data.obj;
    if (*(*op2).val).type_0 != 8 as libc::c_int {
        let mut var: *mut mln_lang_var_t = mln_lang_set_member_search(
            (*obj).members,
            (*(*op2).val).data.s,
        );
        if var.is_null() {
            let mut tmpvar: mln_lang_var_t = mln_lang_var_t {
            ...
            let mut tmpval: mln_lang_val_t = mln_lang_val_t {
                prev: 0 as *mut mln_lang_val_s,
                next: 0 as *mut mln_lang_val_s,
                data: C2RustUnnamed_10 { i: 0 },
                type_0: 0,
                ref_0: 0,
                udata: 0 as *mut mln_lang_val_t,
                func: 0 as *mut mln_lang_func_detail_t,
                not_modify: [0; 1],
                c2rust_padding: [0; 7],
            };
            let mut rn: *mut mln_rbtree_node_t = 0 as *mut mln_rbtree_node_t;
            tmpvar.type_0 = M_LANG_VAR_NORMAL;
            tmpvar.name = (*(*op2).val).data.s;
            tmpvar.val = &mut tmpval;
            tmpvar.in_set = (*obj).in_set;
            tmpvar.next = 0 as *mut mln_lang_var_t;
            tmpvar.prev = tmpvar.next;
            tmpval.data.s = 0 as *mut mln_string_t;
            tmpval.type_0 = 0 as libc::c_int;
            tmpval.ref_0 = 1 as libc::c_int as mln_u32_t;
            var = mln_lang_var_dup(ctx, &mut tmpvar);
            if var.is_null() {
                mln_lang_errmsg(
                    ctx,
                    b"No memory.\0" as *const u8 as *const libc::c_char
            ...
            rn = mln_rbtree_node_new((*obj).members, var as *mut libc::c_void);
            if rn.is_null() {
        ...
        *ret = mln_lang_var_create_call(ctx, (*(*op2).val).data.call);
        if (*ret).is_null() {
            mln_lang_errmsg(
                ctx,
                b"No memory.\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
        ...
        mln_lang_funccall_val_object_add((*(*op2).val).data.call, (*op1).val);
        (*(*op2).val).data.call = 0 as *mut mln_lang_funccall_val_t;
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn mln_lang_obj_negative(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(31 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_reverse(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(32 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_not(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(33 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_pinc(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(34 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_obj_pdec(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_obj_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_obj_operator(
            ctx,
            op1,
            &mut *mln_lang_obj_opr_names.as_mut_ptr().offset(35 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn run_static_initializers() {
    mln_lang_obj_opr_names = [
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_assign_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_pluseq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_subeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_lmoveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_rmoveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_muleq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_diveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_oreq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_andeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_xoreq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_modeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_cor_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_cand_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_cxor_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_equal_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_nonequal_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_lt_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_le_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_gt_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_ge_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_lmov_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_rmov_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_plus_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_sub_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_mul_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_div_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_mod_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_sdec_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_sinc_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_index_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_property_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 26]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_negative_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 26]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_reverse_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_not_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_pinc_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__obj_pdec_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
