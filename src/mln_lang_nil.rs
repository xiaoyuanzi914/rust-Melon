...
#[no_mangle]
pub static mut mln_lang_nil_oprs: mln_lang_method_t = unsafe {
    {
...
unsafe extern "C" fn mln_lang_nil_pluseq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(1 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_subeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(2 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_lmoveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(3 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_rmoveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(4 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_muleq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(5 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_diveq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(6 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_oreq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(7 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_andeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(8 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_xoreq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(9 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_modeq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(10 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_cor(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(11 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_cand(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(12 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_cxor(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(13 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_equal(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(14 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_nonequal(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(15 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_less(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(16 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_lesseq(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(17 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_grea(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(18 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_greale(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(19 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_lmov(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(20 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_rmov(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(21 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_plus(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(22 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_sub(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(23 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_mul(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(24 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_div(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(25 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_mod(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(26 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_sdec(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(27 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_sinc(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(28 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_index(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(29 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_property(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(30 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_negative(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(31 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_reverse(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(32 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_not(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(33 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_pinc(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(34 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn mln_lang_nil_pdec(
    mut ctx: *mut mln_lang_ctx_t,
    mut ret: *mut *mut mln_lang_var_t,
    mut op1: *mut mln_lang_var_t,
    mut op2: *mut mln_lang_var_t,
    ...
    if (*ctx).op_nil_flag() != 0 {
        let mut rc: libc::c_int = mln_lang_funccall_val_operator(
            ctx,
            &mut *mln_lang_nil_opr_names.as_mut_ptr().offset(35 as libc::c_int as isize),
            ret,
            op1,
            op2,
        );
...
unsafe extern "C" fn run_static_initializers() {
    mln_lang_nil_opr_names = [
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_assign_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_pluseq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_subeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_lmoveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_rmoveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 24]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_muleq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_diveq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_oreq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_andeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_xoreq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_modeq_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_cor_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_cand_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_cxor_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_equal_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_nonequal_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_lt_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_le_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_gt_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_ge_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 20]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_lmov_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_rmov_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_plus_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_sub_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_mul_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_div_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_mod_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_sdec_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_sinc_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_index_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 23]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_property_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 26]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_negative_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 26]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_reverse_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_not_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 21]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_pinc_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
        ...
        },
        {
            let mut init = mln_string_t {
                data_ref_pool_ref_0: [0; 4],
                c2rust_padding: [0; 4],
                data: b"__nil_pdec_operator__\0" as *const u8 as *const libc::c_char
                    as mln_u8ptr_t,
                len: (::core::mem::size_of::<[libc::c_char; 22]>() as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong),
            };
